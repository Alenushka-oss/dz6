...
while True:
    ...
    print('2. покупка')
    print('3. список покупок')
    print('4. список пополнений')
    print('5. выход')
    ...
    if choice == '1':
        ...
        #  если денег не хватает- считает, сколько денег есть
...
#продемонстрированные на вебинаре способы- у меня не работают вообще :-/
#возможно, когда- то я пойму эти "архетипы" и "метафоры")))
